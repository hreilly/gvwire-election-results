...
$.ajax({
  url: '/wp-content/elections/data/overview.json'
}).done(function(resp){
  //var resp_string = JSON.stringify(resp);
...
$.ajax({
  url: '/wp-content/elections/data/time.json'
}).done(function(resp){
  //var resp_string = JSON.stringify(resp);
  //$('#fresno-county-data').append(resp_string);
...
$.ajax({
  url: '/wp-content/elections/data/cc3.json'
}).done(function(resp){
  //var resp_string = JSON.stringify(resp);
  //$('#fresno-county-data').append(resp_string);
  var cc3 = resp.data;
...
$.ajax({
  url: '/wp-content/elections/data/cc5.json'
}).done(function(resp){
  //var resp_string = JSON.stringify(resp);
  //$('#fresno-county-data').append(resp_string);
  var cc5 = resp.data;
...
$.ajax({
  url: '/wp-content/elections/data/cc7.json'
}).done(function(resp){
  //var resp_string = JSON.stringify(resp);
  //$('#fresno-county-data').append(resp_string);
  var cc7 = resp.data;
...
$.ajax({
  url: '/wp-content/elections/data/msrA.json'
}).done(function(resp){
  //var resp_string = JSON.stringify(resp);
  //$('#fresno-county-data').append(resp_string);
  var msrA = resp.data;
...
$.ajax({
  url: '/wp-content/elections/data/msrO.json'
}).done(function(resp){
  //var resp_string = JSON.stringify(resp);
  //$('#fresno-county-data').append(resp_string);
  var msrO = resp.data;
...
$.ajax({
  url: '/wp-content/elections/data/msrP.json'
}).done(function(resp){
  //var resp_string = JSON.stringify(resp);
  //$('#fresno-county-data').append(resp_string);
  var msrP = resp.data;
...
$.ajax({
  url: '/wp-content/elections/data/msrQ.json'
}).done(function(resp){
  //var resp_string = JSON.stringify(resp);
  //$('#fresno-county-data').append(resp_string);
  var msrQ = resp.data;
...
$.ajax({
  url: '/wp-content/elections/data/fusd1.json'
}).done(function(resp){
  //var resp_string = JSON.stringify(resp);
  //$('#fresno-county-data').append(resp_string);
  var fusd1 = resp.data;
...
$.ajax({
  url: '/wp-content/elections/data/fusd3.json'
}).done(function(resp){
  //var resp_string = JSON.stringify(resp);
  //$('#fresno-county-data').append(resp_string);
  var fusd3 = resp.data;
...
$.ajax({
  url: '/wp-content/elections/data/fusd4.json'
}).done(function(resp){
  //var resp_string = JSON.stringify(resp);
  //$('#fresno-county-data').append(resp_string);
  var fusd4 = resp.data;
...
$.ajax({
  url: '/wp-content/elections/data/fusd7.json'
}).done(function(resp){
  //var resp_string = JSON.stringify(resp);
  //$('#fresno-county-data').append(resp_string);
  var fusd7 = resp.data;
...
$.ajax({
  url: '/wp-content/elections/data/cenusd1.json'
}).done(function(resp){
  //var resp_string = JSON.stringify(resp);
  //$('#fresno-county-data').append(resp_string);
...
$.ajax({
  url: '/wp-content/elections/data/cenusd2.json'
}).done(function(resp){
  //var resp_string = JSON.stringify(resp);
  //$('#fresno-county-data').append(resp_string);
...
$.ajax({
  url: '/wp-content/elections/data/cenusd4.json'
}).done(function(resp){
  //var resp_string = JSON.stringify(resp);
  //$('#fresno-county-data').append(resp_string);
...
$.ajax({
  url: '/wp-content/elections/data/cenusd7.json'
}).done(function(resp){
  //var resp_string = JSON.stringify(resp);
  //$('#fresno-county-data').append(resp_string);
...
$.ajax({
  url: '/wp-content/elections/data/cusd1.json'
}).done(function(resp){
  //var resp_string = JSON.stringify(resp);
  //$('#fresno-county-data').append(resp_string);
  var cusd1 = resp.data;
...
$.ajax({
  url: '/wp-content/elections/data/cusd3.json'
}).done(function(resp){
  //var resp_string = JSON.stringify(resp);
  //$('#fresno-county-data').append(resp_string);
  var cusd3 = resp.data;
...
$.ajax({
  url: '/wp-content/elections/data/fcboe1.json'
}).done(function(resp){
  //var resp_string = JSON.stringify(resp);
  //$('#fresno-county-data').append(resp_string);
...
$.ajax({
  url: '/wp-content/elections/data/scccd4.json'
}).done(function(resp){
  //var resp_string = JSON.stringify(resp);
  //$('#fresno-county-data').append(resp_string);
...
$.ajax({
  url: '/wp-content/elections/data/scccd5.json'
}).done(function(resp){
  //var resp_string = JSON.stringify(resp);
  //$('#fresno-county-data').append(resp_string);
